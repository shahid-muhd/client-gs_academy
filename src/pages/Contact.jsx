...
function Contact() {
  return (
    <div>
      <section class="bg-white p-5 mt-5 dark:bg-gray-900">
        <div class="container px-6 py-12 mx-auto overflow-hidden">
            ...
            <div class="grid grid-cols-1 gap-12 md:grid-cols-2">
              <div>
                ...
                <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">
                 <a href="mailto:hello@gsacademy.com"> hello@gsacademy.com </a>
                </p>
              </div>
